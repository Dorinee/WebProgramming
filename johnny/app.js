...
if (app.get('env') === 'development') {
  app.locals.pretty = true; // 이렇게 설정하면 이쁜 형태로 나옴.
}
...
const connStr = 'mongodb+srv://KimJuneHyun:helloworld@cluster0-3f9zj.mongodb.net/test?retryWrites=true&w=majority';
...
app.use('/', index);
app.use('/users', users); 
app.use('/items', items); // things로 바꾸자
